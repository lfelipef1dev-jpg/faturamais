  ...
  function register(F) {
    ...
    route('dashboard', function () {
      ...
      return '<div class="page-header"><h1>Visão geral</h1><p>Financial Command Center — ambiente demonstrativo</p></div>' +
        ...
        '</div>' +
        '<div class="chart-card"><div class="chart-card-header"><div><div class="chart-card-title">Receita × Despesas × Resultado (ilustrativo)</div><div class="chart-card-sub">Série demonstrativa</div></div></div>' + multiLineChart(multiSeries, { label: 'Receita vs Despesas', width: 800, height: 240 }) + '</div>' +
        '<div class="grid-2">' +
        '<div class="chart-card"><div class="chart-card-header"><div><div class="chart-card-title">Fluxo de caixa projetado (ilustrativo)</div><div class="chart-card-sub">Próximas 12 semanas</div></div></div>' + lineChart(fluxoData, { label: 'Fluxo de caixa', color: '#2563EB', width: 450, height: 200 }) + '</div>' +

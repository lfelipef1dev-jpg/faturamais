  ...
  function register(F) {
    ...
    route('dashboard', function () {
      ...
      return '<div class="page-header"><h1>Visão geral</h1><p>Financial Command Center — ambiente demonstrativo</p></div>' +
        ...
        '</div>' +
        '<div class="chart-card"><div class="chart-card-header"><div><div class="chart-card-title">Evolução financeira (ilustrativa)</div><div class="chart-card-sub">Série demonstrativa</div></div></div>' + multiLineChart(multiSeries, { label: 'Evolução financeira', width: 800, height: 240 }) + '</div>' +
        '<div class="grid-2">' +
